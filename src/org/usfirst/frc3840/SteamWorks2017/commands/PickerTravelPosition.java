 ...
 *  Team 3840 (TNT)
 *  Command: IntakeMoveToTravelPosition
 *  Created 02/11/17
 *  Description:
...
public class PickerTravelPosition extends Command {
	final String TravelLocation = "TravelPosition";
	
    public PickerTravelPosition() {
    ...
    protected void execute() {
    	 ...
    	 Robot.frontMover.MoveIntakeArmToPosition(TravelLocation);
    }
