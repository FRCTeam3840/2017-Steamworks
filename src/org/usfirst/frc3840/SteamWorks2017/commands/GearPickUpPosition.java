 ...
 * 2017 FRC SteamWorks
 * Team 3840
 * Command to move gear lifter to the pick up location
 */
public class GearPickUpPosition extends Command {
	final String PickGear = "PickGearLocation";

    public GearPickUpPosition() {
    ...
    protected void execute() {
    	...
    	Robot.gearMover.MoveGearArmToPosition(PickGear);
    }
